...
<div class="content">
  ...
  <form class="col-4" method="POST" action="" style="padding-top: 80px;">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="skype" placeholder="Индивидуальный код" name="programm_id">
    </div>
    <div class="form-group">
      <label for="website">Web site</label>
      <input type="text" class="form-control" id="website" placeholder="Web site" name="website">
    </div>
    <div class="form-group">
      <label for="photo">Photo</label>
      <input type="text" style="display: none;" class="loadFileValue" name="photo">
